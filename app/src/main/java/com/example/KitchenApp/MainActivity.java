...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                dbRobotStatus.setValue("BLOCKED");
                return false;
            }
        });
        ...
        dbDeliveryList.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                CustomAdapter foodOrdersAdapter = new CustomAdapter(getApplicationContext());
    ...
    private void updateOrder(
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference dbDeliveryList = database.getReference("delivery_list");
